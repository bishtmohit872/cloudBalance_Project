    ...
    return(
        <div className="flex flex-col items-start overflow-y-hidden space-y-4">
                    ...
                    <div className="h-max flex flex-col items-start space-y-2">
                        ...
                        <div className="h-40 w-[1200px] flex flex-wrap items-start space-y-2">
                            <div className="flex flex-col items-start space-y-1">
                                ...
                                <input type="text" className="w-[400px] py-1 px-2 outline-none border border-gray-300"/>
                            </div>
            ...
            <div className="w-full flex items-center justify-between">
                <button className="w-18 h-8 border border-blue-900 text-blue-800 rounded-sm bg-white text-xs font-bold">Cancel</button>
                
                <button className="w-max h-8 py-1 px-3 border border-blue-800 bg-[#0A3CA2] text-white rounded-sm text-xs font-semibold hover:cursor-pointer" onClick={pageIncr}>Next - Add Customer Managed Policies</button>
            </div>
    ...
    return(
        <div className="size-full flex flex-col items-center">
            ...
            <div className="h-[calc(100%-8%)] w-full py-8 px-16 bg-gray-100 overflow-y-scroll">
                <ActiveComponent value={count} pageIncr={handlePageIncr} pageDecr={handlePageDecr}/>
            </div>
        </div>
    )
}
